  ...
  // Bottom Tab Navigator component can be used in other pages
    return (
        <Tab.Navigator screenOptions = {{
          ...
          <Tab.Screen name="Alerts" component={AlertsScreen} options = {{tabBarIcon: ({ color, size }) => (
            ...
            tabBarShowLabel: false}}/>
            <Tab.Screen name="Contact" component={ContactScreen} options = {{tabBarIcon: ({ color, size }) => (
